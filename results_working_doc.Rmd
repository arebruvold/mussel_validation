...
$$S =  \frac{6 \cdot A_{rm}}{\rho  \cdot \pi \cdot d_{rm}^3},$$
...
\frac{1}{n}\sum_{i=1}^n\sqrt[3]{\frac{6 \cdot A_{p_i}}{S \cdot \pi \rho} } = \frac{1}{n} \sum_{i=1}^n \sqrt[3]{\frac{A_{p_i} \cdot \rho_{r m} \cdot d_{r m}^3}{A_{r m} \cdot \rho}},$$

the particle mass concentration, $c_m$, by

$$c_m = \frac{\sum_{i=1}^nA_{p_i}}{S_{} \cdot t_{meas}\cdot Q_{det}} = \frac{ C_{std} \sum_{i=1}^nA_{p_i}}{t_{meas} \cdot b}, $$
